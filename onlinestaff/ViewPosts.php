...
include './dbcon.php';
  ...
  echo "<br>";
    ...
    $sql = "SELECT  ff.id,ff.name,`title`, `msg`,Date FROM `Posts` p JOIN Followers f ON f.F_Id=p.`fid` LEFT JOIN faculty ff ON ff.id=p.`fid` WHERE f.S_Id =  $studId";
    ...
    $FId= $row["id"];
      ...
      <div class='card text-center '>
        ...
        <div class='card-body'>
          ...
          <a href='sendMsg.php?Fid=$FId&Fname=$name' class='btn btn-primary'>Send Message</a>
        </div>
